...
<head>
    ...
    <meta name="description" content="If 40 men can finish a piece of work in 60 days, in how many days will 75 men finish the same work ?">
    <meta name="keywords" content="If 40 men can finish a piece of work in 60 days, in how many days will 75 men finish the same work ?, enthulearners, enthulearner, q and a website, educational website, learning website, elearning">
    <title>If 40 men can finish a piece of work in 60 days, in how many days will 75 men finish the same work ?</title>
...
<body>
    ...
    <!--CONTENT AREA STARTS HERE-->
        ...
        <div class="container">
            ...
            <h4 class="my-4">Q. If 40 men can finish a piece of work in 60 days, in how many days will 75 men finish the same work ?</h4>

            <h5>Answer</h5>
            <p style="border: 1px solid black; font-size: 22px;" class="px-3">If 40 men can do a piece of work in 60 days<br>
              so, 1 men can do it in 40*60 days = 2400 days<br>
              therefore, 75 men can do it in (2400/75) days i.e., 32 days.<br>
              THANKS
            </p>
            <p style="font-size: 20px; font-weight: bold;">Hope it helps you..!!</p><br>
            <a href="#" data-toggle="modal" data-target="#feedbackformModalCenter" style="font-weight: bold; font-size: 20px;">Give us feedback</a>
        </div><br><br>

        <!--Modals-->

        <!--feedback form modal-->
        <div class="modal fade" id="feedbackformModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="login_form">
                    ...
                    <form class="form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                        <fieldset style="color: white">
                            <legend><h5>Give us feedback</h5></legend>
                            <i class="fa fa-user"></i> Your Name: <input type="text" placeholder="Enter your Name" class="input-area my-2" name="feedback_name" required><br><br>
                            <i class="fa fa-envelope"></i> Your Email: <input type="email" placeholder="Enter your Email" class="input-area my-2" name="feedback_email" required><br><br>
                            <textarea class="feedback_textarea" name="feedback" placeholder="Type your feedback here..." required></textarea><br><br>
                    
                            <button type="submit_feedback" class="submit-btn" name="submit">Submit</button>
        ...
        if(isset($_POST['signup'])){
            ...
            if($username_count > 0){
                ...
                if($submit_user_data){
                    ...
                    IF YOU DID NOT MADE YOUR ACCOUNT ON ENTHULEARNERS, PLEASE DON'T CLICK ON THE LINK.";
        ...
        if(isset($_POST['next'])){
          ...
          if($recover_username_count > 0){
            ...
            NEVER SHARE THIS LINK AS THIS CAN LED TO ACCESS YOUR ACCOUNT TO THAT PERSON.
        ...
        <?php
        //submit feedback code starts here--
        ...
        if(isset($_POST['submit'])){
          ...
          $to = "help.enthulearners@gmail.com";
          $headers = "From: $email \r\n";
          ...
          if($send_mail){
            $reply_from = "help.enthulearners@gmail.com";
            $reply_subject = "Feedback submitted successfully..!!";

            $reply_body = "Hi $name,\n".
                          "Your feedback for ENTHULEARNERS has been submitted successfully. Thank you for taking your time to give us your feedback.";

            $reply_to = $_POST['feedback_email'];
            $reply_headers = "From: $reply_from";

            $send_reply = mail($reply_to, $reply_subject, $reply_body, $reply_headers);
          }else{
            ?>
            <script>
              alert('SORRY..!!'+' Feedback has not been submitted.');
            </script>
            <?php
          }
        }

        //submit feedback code ends here--
        ?>
